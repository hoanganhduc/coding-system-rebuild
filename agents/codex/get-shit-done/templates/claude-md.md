...
**Fallback text:**
```
No project skills found. Add skills to any of: `.agents/skills/`, `.codex/skills/`, `.cursor/skills/`, or `.github/skills/` with a `SKILL.md` index file. Legacy `.claude/skills/` remains supported as a fallback.
```

**Discovery behavior:**
- Scans `.agents/skills/`, `.codex/skills/`, `.cursor/skills/`, `.github/skills/`, then legacy `.claude/skills/` for subdirectories containing `SKILL.md`
