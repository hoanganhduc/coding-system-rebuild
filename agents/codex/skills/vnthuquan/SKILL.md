---
name: "vnthuquan"
description: "Vietnam Thu Quan ebook discovery, validation, dry-run download, and Calibre dry-run handoff."
metadata:
  short-description: "Vietnam Thu Quan ebook discovery, validation, dry-run download, and Calibre dry-run handoff."
---
...
- `~/ai-agents-skills/canonical/skills/vnthuquan/SKILL.md`
