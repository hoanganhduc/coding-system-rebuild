...
- [x] Task: Lock the follow-on graph direction to Sage-assisted on-demand mode.
  ...
  - Files:
    - `/home/hoanganhduc/tasks/tikz-semantic-verifier/SPEC.md`
    - `/home/hoanganhduc/tasks/tikz-semantic-verifier/tasks/plan.md`
    - `/home/hoanganhduc/tasks/tikz-semantic-verifier/tasks/todo.md`
