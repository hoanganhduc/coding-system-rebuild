...
- [x] Task: Finalize the stable helper API and path contract.
  ...
  - Files:
    ...
    - `~/tasks/tikz-draw-skill/SPEC.md`
    - `~/tasks/tikz-draw-skill/tasks/plan.md`
...
- [x] Task: Define `diagram.schema.json` and `figure-brief.schema.json`.
  ...
  - Files:
    - `~/tasks/tikz-draw-skill/shared/spec-schema/diagram.schema.json`
    - `~/tasks/tikz-draw-skill/shared/spec-schema/figure-brief.schema.json`
...
- [x] Task: Build the shared snippet, style, and review-rule assets.
  ...
  - Files:
    - `~/tasks/tikz-draw-skill/shared/snippets/`
    - `~/tasks/tikz-draw-skill/shared/styles/`
    - `~/tasks/tikz-draw-skill/shared/checks/`
