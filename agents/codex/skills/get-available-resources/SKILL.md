...
description: "Detect CPU, memory, disk, and optional accelerator availability before heavy local work."
metadata:
  short-description: "Detect CPU, memory, disk, and optional accelerator availability before heavy local work."
---
...
- `~/ai-agents-skills/canonical/skills/get-available-resources/SKILL.md`
