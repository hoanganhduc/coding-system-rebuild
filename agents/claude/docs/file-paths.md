...
| Skill runner | `~/.claude/skills/_run.sh` |
| Python deps | `~/.claude/.local/` (symlink) |
| Secrets | `~/.claude/secrets.json` |
| Zotero config | `~/.claude/skills/zotero/config.json` |
| Research data | `~/.claude/data/research/` (symlink) |
| Job queue | `~/.claude/data/job-queue/` (symlink) |
...
| Spec / plan / tasks templates | `~/.claude/templates/` |
