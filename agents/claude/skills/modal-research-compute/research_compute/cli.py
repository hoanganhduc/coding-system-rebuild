...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="research-compute", description="Claude broker for Modal-backed research compute.")
...
def load_local_resources() -> dict[str, Any] | None:
    for name in (".claude_resources.json", ".codex_resources.json"):
