...
metadata:
  short-description: "Runtime engine for url-to-screenshot: headless-browser CDP capture, SSRF-safe URL admission, consent dismissal, blank-output detection, and an offline self-test of the deterministic core."
---
...
- `~/ai-agents-skills/canonical/skills/url-to-screenshot-runtime/SKILL.md`
