...
description: "Log durable learnings and propose canonical repo integration plans across install targets."
metadata:
  short-description: "Log durable learnings and propose canonical repo integration plans across install targets."
---
...
- `~/ai-agents-skills/canonical/skills/self-improving-agent/SKILL.md`
