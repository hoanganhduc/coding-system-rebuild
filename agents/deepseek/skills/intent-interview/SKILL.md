...
description: "Elicit and confirm real intent one question at a time before any brief, spec, or code."
metadata:
  short-description: "Elicit and confirm real intent one question at a time before any brief, spec, or code."
---
...
- `~/ai-agents-skills/canonical/skills/intent-interview/SKILL.md`
