...
description: "Cross-agent delegation packet contract for bounded parent-controlled handoffs."
metadata:
  short-description: "Cross-agent delegation packet contract for bounded parent-controlled handoffs."
---
...
- `~/ai-agents-skills/canonical/skills/cross-agent-delegation/SKILL.md`
