...
description: "Plan safe workspace organization with dry-run first, explicit apply, and no silent deletion."
metadata:
  short-description: "Plan safe workspace organization with dry-run first, explicit apply, and no silent deletion."
---
...
- `~/ai-agents-skills/canonical/skills/workspace-rearranger/SKILL.md`
