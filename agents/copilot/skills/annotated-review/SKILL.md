...
description: "Annotated paper review workflow when both annotation and review are requested."
metadata:
  short-description: "Annotated paper review workflow when both annotation and review are requested."
---
...
- `~/ai-agents-skills/canonical/skills/annotated-review/SKILL.md`
