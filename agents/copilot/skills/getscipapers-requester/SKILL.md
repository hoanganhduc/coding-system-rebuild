...
description: "External paper retrieval fallback after local library checks."
metadata:
  short-description: "External paper retrieval fallback after local library checks."
---
...
- `~/ai-agents-skills/canonical/skills/getscipapers-requester/SKILL.md`
