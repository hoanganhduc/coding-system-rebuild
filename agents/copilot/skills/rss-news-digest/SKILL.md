...
description: "Run and manage RSS digest workflows."
metadata:
  short-description: "Run and manage RSS digest workflows."
---
...
- `~/ai-agents-skills/canonical/skills/rss-news-digest/SKILL.md`
