...
description: "Optional inert LeanExplore MCP setup helper for Lean declaration search."
metadata:
  short-description: "Optional inert LeanExplore MCP setup helper for Lean declaration search."
---
...
- `~/ai-agents-skills/canonical/skills/lean-explore-mcp/SKILL.md`
