---
name: "model-router"
description: "Choose an appropriate model, reasoning level, and role for subagents or multi-agent research work."
metadata:
  short-description: "Choose an appropriate model, reasoning level, and role for subagents or multi-agent research work."
---
...
- `~/ai-agents-skills/canonical/skills/model-router/SKILL.md`
